...
@Component({
  selector: 'app-sale-contact-manage-table',
  templateUrl: './sale-contact-manage-table.component.html',
  styleUrls: ['./sale-contact-manage-table.component.css']
})
export class SaleContactManageTableComponent implements OnInit {
