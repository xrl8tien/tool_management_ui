...
export class DetailPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.activateRoute.snapshot.params['id'] == 1) {
      this.pageHeader = "Bảo hiểm tử kỳ";
      ...
      this.pageHeader = "Bảo hiểm bệnh hiểm nghèo";
      ...
      this.pageHeader = "Kế hoạch hưu trí";
      ...
      this.pageHeader = "Bảo hiểm trọn đời";
      ...
      this.pageHeader = "Bảo hiểm đầu tư";
